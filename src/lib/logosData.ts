// Pure Vector SVG Definitions for PortalBuild Brand Assets

export const ICON_MARK_SVG = `<svg viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
  <defs>
  ...
  <rect x="160" y="160" width="704" height="704" rx="192" fill="#090d16" fill-opacity="0.95" stroke="url(#subtleBorder)" stroke-width="12"/>
...
export const FULL_DARK_SVG = `<svg viewBox="0 0 2000 500" fill="none" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <radialGradient id="portalGlowHDark" cx="50%" cy="50%" r="50%">
      <stop offset="0%" stop-color="#f97316" stop-opacity="0.4"/>
      <stop offset="70%" stop-color="#ea580c" stop-opacity="0"/>
    </radialGradient>
    <linearGradient id="orangeGradHDark" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0%" stop-color="#fb923c"/>
      <stop offset="50%" stop-color="#f97316"/>
      <stop offset="100%" stop-color="#ea580c"/>
    </linearGradient>
    <linearGradient id="textGradHDark" x1="0" y1="0" x2="1" y2="0">
      <stop offset="0%" stop-color="#ffffff"/>
      <stop offset="70%" stop-color="#f8fafc"/>
      <stop offset="100%" stop-color="#cbd5e1"/>
    </linearGradient>
    <filter id="coreGlowHDark" x="-50%" y="-50%" width="200%" height="200%">
  ...
  <g transform="translate(40, 25)">
    <!-- Ambient Glow -->
    <circle cx="225" cy="225" r="200" fill="url(#portalGlowHDark)"/>

    <!-- Outer Rounded Squircle Base -->
    <rect x="75" y="75" width="300" height="300" rx="80" fill="#090d16" fill-opacity="0.95" stroke="#ffffff" stroke-opacity="0.2" stroke-width="6"/>

    <!-- Portal Top-Right Aperture Bracket -->
    <path d="M 225 130 L 300 130 C 314 130 325 141 325 155 L 325 225" fill="none" stroke="url(#orangeGradHDark)" stroke-width="14" stroke-linecap="round"/>

    <!-- Portal Bottom-Left Aperture Bracket -->
    <path d="M 225 320 L 150 320 C 136 320 125 309 125 295 L 125 225" fill="none" stroke="url(#orangeGradHDark)" stroke-width="14" stroke-linecap="round"/>
    ...
    <!-- Inner Core Dot -->
    <circle cx="225" cy="225" r="14" fill="#ffffff" filter="url(#coreGlowHDark)"/>
    <circle cx="225" cy="225" r="8" fill="#fb923c"/>
  </g>

  <!-- Typography Section -->
  <text x="490" y="270" font-family="system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-size="140" font-weight="900" letter-spacing="-3" fill="url(#textGradHDark)">Portal<tspan fill="url(#orangeGradHDark)">Build</tspan></text>
...
export const FULL_LIGHT_SVG = `<svg viewBox="0 0 2000 500" fill="none" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <radialGradient id="portalGlowHLight" cx="50%" cy="50%" r="50%">
      <stop offset="0%" stop-color="#ea580c" stop-opacity="0.2"/>
      <stop offset="70%" stop-color="#ea580c" stop-opacity="0"/>
    </radialGradient>
    <linearGradient id="orangeGradHLight" x1="0" y1="0" x2="1" y2="1">
  ...
  <g transform="translate(40, 25)">
    <!-- Ambient Glow -->
    <circle cx="225" cy="225" r="200" fill="url(#portalGlowHLight)"/>

    <!-- Outer Rounded Squircle Base -->
    <rect x="75" y="75" width="300" height="300" rx="80" fill="#0f172a" stroke="#ea580c" stroke-opacity="0.3" stroke-width="6"/>

    <!-- Portal Top-Right Aperture Bracket -->
    <path d="M 225 130 L 300 130 C 314 130 325 141 325 155 L 325 225" fill="none" stroke="url(#orangeGradHLight)" stroke-width="14" stroke-linecap="round"/>

    <!-- Portal Bottom-Left Aperture Bracket -->
    <path d="M 225 320 L 150 320 C 136 320 125 309 125 295 L 125 225" fill="none" stroke="url(#orangeGradHLight)" stroke-width="14" stroke-linecap="round"/>
  ...
  <!-- Typography Section -->
  <text x="490" y="270" font-family="system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-size="140" font-weight="900" letter-spacing="-3" fill="#0f172a">Portal<tspan fill="url(#orangeGradHLight)">Build</tspan></text>
...
export const APP_BADGE_SVG = `<svg viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
  <defs>
