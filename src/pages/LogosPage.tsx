...
export default function LogosPage() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-200 py-12 px-4 sm:px-6 max-w-6xl mx-auto font-sans">
      ...
      <div className="mb-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-white/[0.08] pb-6">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
          ...
          <div className="flex items-center gap-1.5 text-[11px] font-mono text-orange-400 bg-orange-500/10 border border-orange-500/20 px-3 py-1 rounded-full">
